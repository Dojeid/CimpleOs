...
// Minimal set for A-Z, 0-9, and some symbols.
// In a real scenario, this would be the full IBM VGA font.
// For this environment, I'm providing a usable subset to ensure text renders.

const uint8_t font8x8_basic[128][8] = {
    {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // 0x00 (NUL) - used as space
    // ... fillers for 1-31 ...
    ...
    {0x36, 0x49, 0x7F, 0x49, 0x6D, 0x00, 0x00, 0x00}, // 36 $
    {0x00, 0x63, 0x33, 0x18, 0x0C, 0x66, 0x00, 0x00}, // 37 %
    {0x00, 0x36, 0x49, 0x30, 0x20, 0x50, 0x20, 0x00}, // 38 &
    ...
    {0x7C, 0x66, 0x66, 0x7C, 0x6C, 0x66, 0xE6, 0x00}, // 82 R
    ...
    {0x1C, 0x20, 0x7C, 0x20, 0x20, 0x20, 0x20, 0x00}, // 102 f
